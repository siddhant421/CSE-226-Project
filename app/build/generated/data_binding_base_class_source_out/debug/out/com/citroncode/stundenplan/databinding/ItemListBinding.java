...
public final class ItemListBinding implements ViewBinding {
  ...
  private ItemListBinding(@NonNull LinearLayout rootView, @NonNull RelativeLayout rlFriday,
  ...
  public static ItemListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemListBinding((LinearLayout) rootView, rlFriday, rlMonday, rlThursday, rlTuesday,
          rlWednesday, tvFriday, tvMonday, tvSubject, tvThursday, tvTuesday, tvWednesday);
    }
